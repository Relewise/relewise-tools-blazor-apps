...
6. Run the complete validation commands in `AGENTS.md`: Release build, unit/component tests, AOT publish, and published browser tests. Exercise affected UI paths and external CDN functionality when relevant. Add regression tests for actual upgrade fallout; avoid broad refactoring.
