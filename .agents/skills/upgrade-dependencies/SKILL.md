...
MessagePack policy: keep the 2.x major line (currently 2.5.302). Do not upgrade to 3.x during dependency upgrades. Report any remaining advisories or newer-major recommendations without overriding this policy.
